...
# Form implementation generated from reading ui file 'nitrokeyapp/ui/key_generation.ui'
#
...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("nitrokeyapp/ui/images/new/down_arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
