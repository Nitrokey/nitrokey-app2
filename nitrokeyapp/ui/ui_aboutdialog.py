...
class Ui_AboutDialog(object):
    ...
    def retranslateUi(self, AboutDialog):
        ...
        self.label_7.setText(
            _translate(
                "AboutDialog",
                "<html><head/><body><p>This application allows you to configure the Nitrokey 3.</p></body></html>",
            )
        )
