...
from nitropyapp.pynitrokey_for_gui import Nk3Context, list, version, wink, nk3_update, nk3_update_helper, change_pin, set_pin
...
class Nk3Button(QtWidgets.QWidget):
    ...
    def __init__(self, device, nitrokeys_window, layout_nk_btns, nitrokey3_frame, nk3_lineedit_uuid, nk3_lineedit_path, nk3_lineedit_version, tabs, update_nk3_btn, progressBarUpdate, change_pin_open_dialog, set_pin_open_dialog, change_pin_dialog, set_pin_dialog, buttonLayout_nk3):
        super().__init__()
        self.device = device
        ...
        self.btn_nk3 = QtWidgets.QPushButton(QtGui.QIcon(":/images/icon/usb_new.png"),"Nitrokey 3:"f"{self.device.uuid().value%10000}")
        ...
        self.set_pin_dialog.btn_ok.clicked.connect(lambda:set_pin(self.ctx, self.set_pin_dialog.new_pin.text(), self.set_pin_dialog.confirm_new_pin.text()))
